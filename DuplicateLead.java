...
WebDriverManager.chromedriver().setup();
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("TAFE");
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Saravanan");
		driver.findElement(By.id("createLeadForm_lastName")).sendKeys("R");
		driver.findElement(By.id("createLeadForm_firstNameLocal")).sendKeys("TAFE");
		...
		driver.findElement(By.id("createLeadForm_companyName")).sendKeys("Duplicate TAFE");
		driver.findElement(By.id("createLeadForm_firstName")).clear();
		driver.findElement(By.id("createLeadForm_firstName")).sendKeys("Duplicate Saravanan");
		driver.findElement(By.className("smallSubmit")).click();
